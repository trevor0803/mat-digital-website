...
A sentence or two is enough. Do not add separate project-size, timeline, condition, or additional-information questions by default.
...
Do not use city/location instead of ZIP by default. Do not add a second comments/additional-info box because the project-description field already covers that information.
...
## Default Rule
The default contractor lead form is three steps: **Service → Short project description → Contact + ZIP**. Add more questions only when they are operationally necessary or the client explicitly requests them.
